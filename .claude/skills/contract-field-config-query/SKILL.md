...
| 维度 | 用户可能的说法 | 对应参数 |
|------|---------------|---------|
| 业态 | 整装/团装/局装/翻新全案 | business_type |
| 品牌 | 被窝/圣都 | gb_code, company_code |
| 合同类型 | 认购合同/设计合同/正式套餐合同 | contract_type |
| 版本 | 2.0/2.5/预报价 | version |

### 第二步：检查维度完整性

检查是否已获取全部 5 个维度：

- ✅ **业态** (business_type)：是否明确？
- ✅ **城市** (gb_code)：是否明确品牌？（被窝=110000, 圣都=0）
- ✅ **分公司** (company_code)：是否明确品牌？（被窝='V201601528', 圣都=''）
- ✅ **合同类型** (contract_type)：是否明确？
- ✅ **版本** (version)：是否明确？

### 第三步：引导用户补充缺失维度

**如果用户未提供完整信息，必须主动询问补充。**
